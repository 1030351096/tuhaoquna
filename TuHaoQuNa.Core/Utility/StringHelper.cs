...
namespace TuHaoQuNa.Core.Utility
{
    public class StringHelper
    {
        ...
        public static string ReplacePart(string s, char c, int l)
        {
            if (s.Length <= l)
                s = "".PadLeft(l, c);
            else
            {
                int a = s.Length - l;
                int start = (a - a % 2) / 2;
                s = s.Substring(0, start) + "".PadLeft(l, c) + s.Substring(start + l);
            }
            return s;
        }
        ...
        /// <param name="ch"></param>        
        /// <returns></returns>        
        public static String GetFirstPinyin(Char ch)
        {
            var rs = GetPinyin(ch);
        ...
        public static String GetFirstPinyin(String str)
        {
            ...
            {
                sb.Append(GetFirstPinyin(chs[i]));
            }
