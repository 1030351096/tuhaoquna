...
namespace DripOldDriver.Web
{
	/// <summary>DripOldDriver Web 远程内容处理类库</summary>
	public class Remote : IDisposable
	{
		...
		/// <exception cref="DripOldDriver.ArgumentNullOrEmptyException">指定的 URL 为 null 或 empty</exception>
