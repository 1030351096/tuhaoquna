...
namespace TuHaoQuNa.Core.Utility
{
    ...
    public class ImageUtil
    {
        ...
        public static void MakeThumbnail(string originalImagePath, string thumbnailPath, int width, int height, string mode, bool isaddwatermark, ImagePosition imagePosition, string waterImage = null, int quality = 75)
        {
            ...
            {
                MakeThumbnail(originalImage, thumbnailPath, width, height, mode, isaddwatermark, imagePosition, waterImage, quality);
            }
        }
        ...
        /// 生成缩略图
        /// </summary>
        /// <param name="originalStream">源图流（物理路径）</param>
        /// <param name="thumbnailPath">缩略图路径（物理路径）</param>
        /// <param name="width">缩略图宽度</param>
        /// <param name="height">缩略图高度</param>
        /// <param name="mode">生成缩略图的方式</param>	
        ...
        /// <param name="imagePosition">水印位置</param>	
        /// <param name="waterImage">水印图片名称</param>	
        public static void MakeThumbnail(Stream originalStream, string thumbnailPath, int width, int height, string mode = "Cut", bool isaddwatermark = false, ImagePosition imagePosition = ImagePosition.Default, string waterImage = null, int quality = 75)
        {
        ...
        /// <param name="imagePosition">水印位置</param>	
        /// <param name="waterImage">水印图片名称</param>	
        public static void MakeThumbnail(Image originalImage, string thumbnailPath, int width, int height, string mode = "Cut", bool isaddwatermark = false, ImagePosition imagePosition = ImagePosition.Default, string waterImage = null, int quality = 75)
        {
            ...
            switch (mode)
            {
                ...
                case "Cut"://指定高宽裁减（不变形）				
                    ...
                    else if (originalImage.Width > towidth || originalImage.Height > toheight)
                    {
