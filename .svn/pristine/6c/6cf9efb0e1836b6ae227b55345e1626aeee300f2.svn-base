...
namespace TuHaoQuNa.Core.Utility
{
    ...
    public static class StringUtil
    {
        ...
        {
            return InArray(str, stringarray.Split(new string[] { strsplit }, StringSplitOptions.None), false);
        }
        ...
        {
            return InArray(str, stringarray.Split(new string[] { strsplit }, StringSplitOptions.None), caseInsensetive);
        }
        ...
        /// <param name="groupKeys">正则表达式分组关键字</param>
        /// <returns></returns>
        public static Dictionary<string, string[]> GetRegString(string str, string regStr, params string[] groupKeys)
        {
            MatchCollection m;
            Regex r;
            r = new Regex(regStr, RegexOptions.IgnoreCase | RegexOptions.Singleline);
            m = r.Matches(str);
        ...
        /// <returns></returns>
        public static bool HavaEchoChar(string str1, string str2)
        {
        ...
        /// <param name="str2">替换的字符串</param>
        /// <param name="length">长度</param>
        /// <returns></returns>
        public static string Stuff(string str1, int start, string str2 = "", int length = 1)
        {
            return str1.Substring(0, start) + str2 + str1.Substring(start + length);
        }

        public static int Asc(char ch)
        {
            System.Text.ASCIIEncoding asciiEncoding = new System.Text.ASCIIEncoding();
            int intAsciiCode = (int)asciiEncoding.GetBytes(new char[] { ch })[0];
            return (intAsciiCode);
        }
        ...
        public static char Chr(int asciiCode)
        {
            ...
            var strCharacter = asciiEncoding.GetString(byteArray)[0];
            return strCharacter;
        }
